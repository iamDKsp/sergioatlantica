...
import {
  Leaf, Phone, Instagram, Facebook, Youtube, Star,
  ArrowRight, CheckCircle, Menu, X, Search, MapPin, Mail, ShieldCheck,
  Award, TrendingUp, HeartPulse, Droplets, Sparkles, Gift
} from 'lucide-react';
import {
  Accordion,
  AccordionContent,
  ...
  return (
    <div className="min-h-screen bg-white font-sans text-slate-800 overflow-x-hidden">
      <style>{`
        ...
        .gradient-hero { background: linear-gradient(135deg, var(--an-beige) 0%, var(--an-white) 100%); }
      `}</style>
              ...
              <FadeInSection delay={200}>
                <div className="relative rounded-2xl overflow-hidden shadow-2xl shadow-an-dark-green/10 border-4 border-white aspect-[4/3] lg:aspect-square flex items-center justify-center bg-white">
                  <img
                    ...
                    alt="Produtos Atlântica Natural"
      ...
      <section className="py-16 bg-an-dark-green text-white">
        <div className="container mx-auto px-4 md:px-8">
          <div className="grid grid-cols-2 lg:grid-cols-5 gap-8 text-center divide-x divide-white/10">
            {[
              { num: "+300", label: "Franquias pelo Brasil" },
              { num: "+4", label: "Anos no mercado" },
              { num: "+20", label: "Carros pagos" },
              { num: "+15", label: "Viagens realizadas" },
              { num: "100%", label: "Lucro no sistema online", span: true }
            ].map((stat, idx) => (
              <FadeInSection key={idx} delay={idx * 100} className={`px-2 ${stat.span ? 'col-span-2 lg:col-span-1 border-x-0 lg:border-l border-white/10' : ''}`}>
                <div className="text-4xl md:text-5xl font-black text-an-gold mb-2">{stat.num}</div>
                <div className="text-sm uppercase tracking-wider opacity-90 font-medium">{stat.label}</div>
              </FadeInSection>
            ))}
          </div>
        </div>
            ...
            {[
              ...
              <FadeInSection key={idx} delay={idx * 150} className="bg-slate-50 p-8 rounded-2xl relative">
                <div className="absolute top-8 left-8 text-an-gold/20">
                  <svg width="40" height="40" viewBox="0 0 24 24" fill="currentColor"><path d="M14.017 21L16.41 14.596H11.41V3H21.41V14.596L18.667 21H14.017ZM5.017 21L7.41 14.596H2.41V3H12.41V14.596L9.667 21H5.017Z" /></svg>
                </div>
      ...
      <footer id="contato" className="bg-an-dark-green pt-20 pb-8 border-t-[8px] border-an-gold">
        <div className="container mx-auto px-4 md:px-8">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
            ...
            <div>
              ...
              <div className="space-y-4">
                ...
                <a href="mailto:contato@atlanticabauru.com.br" className="flex items-center gap-3 text-white/80 hover:text-white transition-colors group">
          ...
          <div className="border-t border-white/10 pt-8 flex flex-col md:flex-row items-center justify-between gap-4">
            ...
            <div className="text-white/40 text-xs">Revendedor Independente</div>
          </div>
        </div>
      </footer>
